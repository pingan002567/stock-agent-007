DEFAULT_TOOLS = [
    ...
    {"domain": "data-source", "name": "list_data_sources", "risk": "low", "status": "enabled"},
    {"domain": "data-source", "name": "describe_data_capability", "risk": "low", "status": "enabled"},
    {"domain": "data-source", "name": "invoke_data_capability", "risk": "medium", "status": "enabled"},
    ...
    {"domain": "risk", "name": "update_risk_policy", "risk": "medium", "status": "enabled"},
    {"domain": "risk", "name": "create_risk_policy", "risk": "medium", "status": "enabled"},
    {"domain": "risk", "name": "activate_risk_policy", "risk": "medium", "status": "enabled"},
