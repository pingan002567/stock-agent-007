        ...
        <div className="llm-dialog-body">
          ...
          {provider.requires_key ? (
            <label className="page-stack" style={{ gap: 4 }}>
              <span className="muted" style={{ fontSize: 12 }}>{keyLabel}</span>
              <input
                type="password"
                autoFocus
            ...
            <p className="llm-hint">这项服务通常不用密钥，接上后就能选默认模型。</p>
          )}
